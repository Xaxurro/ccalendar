...
#define REGEX_RULES_DAY		REGEX_FIXED_DAY_MONTH	"|" REGEX_DYNAMIC_RANGE_DAY_MONTH	"|" REGEX_DAY_OF_WEEK 
#define REGEX_RULES_MONTH	REGEX_FIXED_DAY_MONTH	"|" REGEX_DYNAMIC_RANGE_DAY_MONTH
#define REGEX_RULES_YEAR	REGEX_FIXED_YEAR	"|" REGEX_DYNAMIC_RANGE_YEAR
